...
function findWasmBinary() {
  return locateFile("PicoPanda_Emulator.wasm");
}
...
var ASM_CONSTS = {
  ...
  206718: () => window.innerWidth,
  206748: () => window.innerHeight
};
