...
{% assign repo = site.repo_url | default: site.github.repository_url | default: "https://github.com/picopanda/picopanda-game-dev-env" %}
> This page mirrors the [README]({{ repo }}/blob/main/README.md) in the repository. Shell commands use paths relative to the **repo root** after you clone the project.
